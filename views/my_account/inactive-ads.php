		...
		<div class="container">
			...
			<div class="ad-profile section">	
					...
					<ul class="user-menu">
						...
						<li class="active"><a href="<?= base_url('my-account/deactive-ads');?>">Deactive ads</a></li>
	        ...
	        {  
    		 ...
    		 foreach ($inactive_ads as  $value) {
	                ...
	                $today = date('Y-m-d');
              		...
              		$CI =& get_instance();
              		$CI->load->model('m_myaccount');
					$array_reason = $CI->m_myaccount->get_reason($ad_id,$status_id);//$value->admin_reason;
