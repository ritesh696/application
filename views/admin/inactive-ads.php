	...
	<section id="main" class="clearfix myads-page">
		<div class="container">
			...
			<div class="breadcrumb-section">
				<!-- breadcrumb -->
				<!-- breadcrumb -->						
				<h2 class="title">Deactive Ads</h2>
			</div><!-- banner -->
			...
			<div class="ad-profile section">	
					...
					<ul class="user-menu">
						...
						<li class="active"><a href="<?= base_url('siteadmin/deactive-ads');?>">Deactive ads</a></li>
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="my-ads section">
							<h2>Deactive ads
									<span  class="" id="spn_total_ads" style="font-size:15px">( <?= count($inactive_ads);?> Ads )	</span>
									<span class="mygreen pull-right"  id="spn_msg" style="font-size:20px" ></span>
							</h2>
							<!-- ad-item -->
							
			<?php 				
			if(isset($inactive_ads) && $inactive_ads != null)        
	        {  

    		 foreach ($inactive_ads as  $value) {
	            	$data_price	='';	    
	                $ad_id = $value->ad_id;
					...
					$user_reason = $array_reason[0]['user_reason'];
								...
								<div class="item-info col-sm-8">
									...
									<div class="ad-meta">
										<div class="meta-content">
                                            ...
                                            { ?> 	
												<span class="dated">Deactive On: <a href="#">Today <?= $time; ?></a></span>
											<?php }else{ ?>
												<span class="dated">Deactive On: <a href="#"><?= $dateformate; ?> </a></span>	
											<?php } ?>
										...
										<div class="user-option pull-right">
											...
											<!-- <a class="delete-item" href="javascript:void(0);" data-toggle="tooltip" data-placement="top" title="Delete this ad" onclick="fun_delete_ads('<?= $ad_id; ?>');"><i class="fa fa-times"></i></a> -->
										</div><!-- item-info-right -->
									</div><!-- ad-meta -->
								</div><!-- item-info -->
							</div><!-- ad-item -->
...
var total_ads ='<?= count($inactive_ads);?>';
