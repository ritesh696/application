		...
		<div class="container">
			...
			<div class="ad-profile section">
					...
					<ul class="user-menu">
						...
						<li class="active" ><a href="<?= base_url('siteadmin/active-ads');?>">Active ads</a></li>
					...
					<div class="col-sm-12">
						<div class="my-ads section">
							<h2>Active ads
									...
									<span  id="spn_total_ads" style="font-size:15px">( <?= count($active_ads);?> Ads )	</span>
								...
								<div class="item-info col-sm-8">
									...
									<div class="ad-meta">
										...
										<div class="user-option pull-right">
											...
											<a class="delete-item" href="javascript:void(0);" onclick="fun_deactive_ads('<?= $ad_id; ?>','<?= $user_id; ?>');" data-toggle="tooltip" data-placement="top" title="Deactive this ad"><i class="fa fa-times"></i></a>
										</div><!-- item-info-right -->
									</div><!-- ad-meta -->
								</div><!-- item-info -->
							</div><!-- ad-item -->
...
var total_ads ='<?= count($active_ads);?>';
