			...
			<div class="banner">
				...
				<div class="banner-form banner-form-full">
					<form action="#">
						...
						<button type="button" class="form-control" value="Search">Search</button>
					</form>
				</div><!-- banner-form -->
			</div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		show_data(search_val,sub_category_id,arr_price,arr_conditions,price_from,price_to,offset,perpage);
...
function show_data(search_val,sub_category_id,arr_price,arr_conditions,price_from,price_to,offset,perpage)
{
